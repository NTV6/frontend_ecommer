      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-rose-100 h-fit">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Địa chỉ showroom</h3>
                    <p className="text-gray-600">123 Đường ABC, Quận 1, TP.HCM</p>
                    <p className="text-gray-600">Tầng 2-3, Building Fashion Center</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">1900 1234 (miễn phí)</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">contact@savani.com</p>
                    <p className="text-gray-600">support@savani.com</p>
                  </div>
                </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-rose-100">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full md:w-auto bg-gradient-to-r from-rose-500 to-pink-500 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:from-rose-600 hover:to-pink-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center gap-2"
                >
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              <div className="bg-white rounded-2xl p-6 border border-rose-100 shadow-lg">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Dịch vụ VIP</h3>
      ...
      <div className="bg-gray-100 py-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl">
            <div className="h-96 bg-gradient-to-r from-rose-200 to-pink-200 rounded-2xl flex items-center justify-center">
