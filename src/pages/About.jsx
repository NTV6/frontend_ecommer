      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-16">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-white max-w-3xl mx-auto leading-relaxed">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-white">
            ...
            <button className="bg-white text-blue-600 dark:bg-gray-900 dark:text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
              Xem bộ sưu tập →
            </button>
          </div>
        </div>
